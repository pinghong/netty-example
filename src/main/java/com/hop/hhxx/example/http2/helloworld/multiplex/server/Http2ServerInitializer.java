...
package com.hop.hhxx.example.http2.helloworld.multiplex.server;
...
import io.netty.example.http2.helloworld.multiplex.server.*;
        ...
        public UpgradeCodec newUpgradeCodec(CharSequence protocol) {
            if (AsciiString.contentEquals(Http2CodecUtil.HTTP_UPGRADE_PROTOCOL_NAME, protocol)) {
                return new Http2ServerUpgradeCodec(new Http2MultiplexCodec(true,
                      new io.netty.example.http2.helloworld.multiplex.server.HelloWorldHttp2Handler()));
            } else {
                return null;
            }
        }
