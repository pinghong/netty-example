 ...
 * the License.
 */
package com.hop.hhxx.example.http2.helloworld.client;
...
import io.netty.example.http2.helloworld.client.*;
...
public class Http2ClientInitializer extends ChannelInitializer<SocketChannel> {
    ...
    private io.netty.example.http2.helloworld.client.HttpResponseHandler responseHandler;
    private io.netty.example.http2.helloworld.client.Http2SettingsHandler settingsHandler;
    ...
    public io.netty.example.http2.helloworld.client.HttpResponseHandler responseHandler() {
